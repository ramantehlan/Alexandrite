...
import static com.alexandrite.starting.R.id.sdPrivateDirectoryTree;
import static com.alexandrite.starting.R.id.sdPublicDirectoryTree;
...
public class Files extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(new File(this.getFilesDir() + "/test.txt").exists()){
            Toast.makeText(getBaseContext() , readCacheFile(getFilesDir(), "test.txt") , Toast.LENGTH_LONG).show();
        }else {
            writeCacheFile(getFilesDir(), "test.txt" , "This is a content of test.txt file. Just for testing.");
        }
